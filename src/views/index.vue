        ...
        <div class="panel equipment">
          ...
          <div class="trend-box">
            <div class="trend-item clearfix">
              ...
              <span class="right">{{trendvalue.maxpercent}} <i class="trend-item-up"></i></span>

            </div>
            <div class="trend-item clearfix">
              <h3 class="trend-item-h3">Min</h3>
              <span class=" trend-item-h3left">{{trendvalue.min}}</span>
              <span class="right">{{trendvalue.minpercent}} <i class="trend-item-down"></i></span>
      ...
      <div class="colum">
        ...
        <div class="panel warn-statistics">
          <div class="warn-title">
            <img
              class="warn-img"
              src="../assets/image/statistics.png"
              alt=""
            >
          ...
          <div class="warn-statistics-chart">
            <RealAlert></RealAlert>
          </div>
        </div>
        <!-- 实时警情区域 -->
        <div class="panel realwarm-list">
          <div class="warn-title realwarm-titlebox">
            <div class="flex">
              <img
                class="warn-img"
            ...
            <div class="warn-title-rank">
              <ul clearfix>
                <li
                  class="alarm-rank-font"
                  v-for="(item,i) in rank"
                  :key="i"
                ><span>{{item.rank}}</span><span class="rank-value">{{item.value}}</span></li>
              </ul>
            </div>
          </div>
...
export default {
  ...
  data () {
    return {
      chart: null,
      numArr: [1, 5, 6, 7, 8],
      warndata: [{ name: '火灾报警设备', value: '6583' }, { name: '水系统监测', value: '2016' }, { name: '电器火灾监测', value: '1064' }],
      riskData: [{ area: '锦江区', value: '11.7' }, { area: '锦江区', value: '11.7' }, { area: '锦江区', value: '11.7' }, { area: '锦江区', value: '11.7' }, { area: '锦江区', value: '11.7' }, { area: '锦江区', value: '11.7' }, { area: '锦江区', value: '11.7' }, { area: '锦江区', value: '11.7' }, { area: '锦江区', value: '11.7' }, { area: '锦江区', value: '11.7' }, { area: '锦江区', value: '11.7' }, { area: '锦江区', value: '11.7' }, { area: '锦江区', value: '11.7' }],
      trendvalue: { max: 17, maxpercent: '24%', min: 3, minpercent: '24%', ave: 5, avepercent: '15%' },
      // 实时警情级别数据
...
.panel {
  ...
  border-width: 1.6375rem 1.475rem 0.25rem 1.65rem;
  padding: 5px;
